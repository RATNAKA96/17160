                ...
                <div class="admin-body">
                    <div class="container">
                        <div style="border:1px solid #c5c5c5;min-height:300px;margin-top: 50px;padding:30px;" class="col-md-12 w3_agile_about_grid_left">
                            <h2 style="text-align:center;"><?php echo $getAppliedNominations[0]['title']; ?></h2><hr>
                            <h3>Description:</h3>
                            <div class="col-md-12">
                                <p style="text-align: justify;"><?php echo $getAppliedNominations[0]['description']; ?></p>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Qualification:</h3>
                                    <div class="col-md-12">
                                        <p style="text-align: justify;"><?php echo $getAppliedNominations[0]['eligibility']; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h3>Experience:</h3>
                                    <div class="col-md-12">
                                        <p style="text-align: justify;"><?php echo $getAppliedNominations[0]['experience']; ?> Years</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Duration:</h3>
                                    <div class="col-md-12">
                                        <p style="text-align: justify;"><?php echo $getAppliedNominations[0]['session_duration']; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h3>Department:</h3>
                                    <div class="col-md-12">
                                        <p style="text-align: justify;"><?php echo $getAppliedNominations[0]['dept']; ?> Years</p>
                                    </div>
                                </div>
                            </div>
                            <h3>Dates:</h3>
                            <div class="col-md-8">
                                <p>Application Closing On <?php echo $getAppliedNominations[0]['last_date_apply'] ?></p>
                                <p>Training Starts From <?php echo $getAppliedNominations[0]['date_of_session'] ?></p>
                            </div>
                        </div>
                    </div>
