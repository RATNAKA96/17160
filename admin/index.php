...
<html lang="en">
    <head>
        <title>VC Portal | Admin Login</title>
        <!-- for-mobile-apps -->
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown" id="login-signup">
                                    ...
                                    <ul class="dropdown-menu agile_short_dropdown">
                                        <li><a href="index.php"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Admin Login</a></li>
                ...
                <div class="row">
                    ...
                    <div class="admin-login-form col-md-3">
                        ...
                        <form action="login.php" method="post">
                            ...
                            <center><input class="admin-login-submit" type="submit"></center>
                        </form>
                    </div>
                </div>
            </div>
