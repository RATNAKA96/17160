    ...
    <body>
        ...
        <div class="container ">
            <div class="margin-50">
                ...
                <h3>What will be the selection criteria for trainee?</h3>
                <div style="inline:flex;"><b>Ans:</b><p>Selection criteria would be based on the qualification of the user and his work experience.</p></div>
                <h3>What are the perks for the trainees?</h3>
                <div style="inline:flex;"><b>Ans:</b><p>He will be honoured with the Head of the Directorate and will have some interacting sessions with HoDs.</p></div>
                <h3>What is the duration for a single session in a day?</h3>
                <div style="inline:flex;"><b>Ans:</b><p>2 to 3 hours a day in two sessions per day pre-lunch and post lunch session.</p></div>
                <h3>What is the Qualification of the people attending the session?</h3>
                <div style="inline:flex;"><b>Ans:</b><p>Probably the employees of the respective Directorates. And the people who wanted to attend the session with their own interest.</p></div>
            </div>
        </div>
