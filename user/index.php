...
<html lang="en">
    <head>
        <title>VC Portal | User Login</title>
        <!-- for-mobile-apps -->
                        ...
                        <div class="modal-content" id="login-box">
                            <div class="left">
                                ...
                                <form style="" action="login.php" method="post">
                                    ...
                                    <input type="hidden" name="hash" value="<?php echo $_SESSION['userLoginHash']; ?>" />
                                    <input type="hidden" name="action" value="loginForm" />
                                    <center><input type="submit" name="signup_submit" value="Sign In" /></center>
                                </form>
                            </div>
                            <div class="right">
                                <span class="loginwith">New User Sign Up Here</span>

                                <a href="register.php"><input style="margin-left: 50px;" type="submit" value="Sign Up" /></a>
                            </div>
                            <div class="or">OR</div>
                        </div>
                    </div>
