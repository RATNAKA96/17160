...
include_once '../config/config.php';
session_start();
$_SESSION['admin']['loginHash'] = token(10);
if ($_GET['msg']) {
...
<html lang="en">
    <head>
        <title>VC Portal | Department Admin Login</title>
        <!-- for-mobile-apps -->
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown" id="login-signup">
                                    ...
                                    <ul class="dropdown-menu agile_short_dropdown">
                                        ...
                                        <li><a href="index.php"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Department Admin Login</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="admin-login-form col-md-3">
                        <h3 style="text-align: center;margin-bottom: 20px;">Department Admin Login</h3>
                        ...
                        <form action="login.php" method="post">
                            ...
                            <input name="hash" type="hidden" value="<?php echo $_SESSION['admin']['loginHash']; ?>">
                            <center><input style="width:130px;" class="admin-login-submit" type="submit"></center>
                        </form>
                    </div>
                </div>
            </div>
