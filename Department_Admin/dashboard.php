...
<html lang="en">
    <head>
        <title>VC Portal | Department Admin</title>
        <!-- for-mobile-apps -->
    ...
    <body>
                        ...
                        <div class="col-md-6">
                            <div class="nomination-header">
                                ...
                                <div class="header__text-group text-center">
                                    <h1 class="header__heading">Request Training Session</h1>
                            ...
                            <div class="form-register">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="dept" class="input-full form-control">
                                        <option value="<?php echo $_SESSION['admin']['username']; ?>"><?php echo $_SESSION['admin']['username']; ?></option>
                                    </select>
        ...
        <?php
        $getAppliedNominations = runQuery("SELECT * FROM `nominations` n WHERE `dept` = '" . $_SESSION['admin']['username'] . "'");
        ?>
        ...
        <div class="admin-body"> 
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <button type="button" data-toggle="modal" data-target="#NomintionModel" class="add-nomie btn btn-info btn-lg"><span class="glyphicon glyphicon glyphicon-plus" aria-hidden="true"></span> Request  Training Session</button>
                    </div>
                    <div class="col-md-6">
                        <button type="button" data-toggle="modal" data-target="#NewsModel" class="add-news btn btn-info btn-lg"><span class="glyphicon glyphicon glyphicon-plus" aria-hidden="true"></span> Add News</button>
                    </div>
                </div>
            </div>
            <div class="container">
                    ...
                    <tbody>
                        ...
                        foreach ($getAppliedNominations as $key => $value) {
                            ...
                            <tr <?php if ($status == 'Completed') { ?> style="background-color: #FFFBCB;" <?php } else if ($status == 'Pending') { ?> style="background-color: #FFFBCB;" <?php } else { ?> style="background-color: #deffe3;" <?php } ?> style="cursor:pointer;" onclick="openNomination('<?php echo $getAppliedNominations[$key]['nid']; ?>')">
                                ...
                                <td style="margin:5px;"><?php echo $getAppliedNominations[$key]['status']; ?></td>
