...
if ((!empty($_SESSION['NominationHash'])) && ($_SESSION['NominationHash'] == $_POST['hash'])) {
    ...
    $date = TodayDate();
    $postNomination = exeQuery("INSERT INTO `nomination_request`(`title`,`date`,`eligibility`, `experience`, `description`, `status`, `date_of_session`, `last_date_apply`,  `dept`, `session_duration`,`verify`) VALUES "
            . "('$title','$date','$qualification','$experience','$description','Pending','$fdate','$ldate','$dept','$dur','N')");
